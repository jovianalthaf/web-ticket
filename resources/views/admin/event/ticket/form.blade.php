<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            Event &raquo; {{ $event->name }} &raquo; Ticket &raquo; {{ isset($event) ? 'Edit' : 'Buat' }}
            ...
            <div class="overflow-hidden shadow sm:rounded-md">
                <div class="px-4 py-5 bg-white sm:p-6">
                    <form method="POST"
                        ...
                        <div class="mb-6">
                            <label for="max_buy" class="block mb-2 text-sm">Max Pembelian</label>
                            <input type="text" name="max_buy"
                                class="bg-gray-50 border border-gray-300 rounded-lg w-full p-2.5"
                        ...
                        <button type="submit"
                            class="text-white bg-blue-700  rounded w-full sm:w-auto px-5 py-2.5 text-center">
                            Simpan
                        </button>
                    </form>
